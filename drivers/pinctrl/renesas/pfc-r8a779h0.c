...
#define FM(x)		FN_##x,
	...
	{ PINMUX_CFG_REG("IP0SR4", ADDR_ASSIGN_RGID(0xE6060060, CONFIG_RCAR_RGID), 32, 4, GROUP(
		IP0SR4_31_28
		IP0SR4_27_24
		IP0SR4_23_20
		IP0SR4_19_16
	...
	{ PINMUX_CFG_REG("IP1SR4", ADDR_ASSIGN_RGID(0xE6060064, CONFIG_RCAR_RGID), 32, 4, GROUP(
		IP1SR4_31_28
		IP1SR4_27_24
		IP1SR4_23_20
		IP1SR4_19_16
	...
	{ PINMUX_CFG_REG("IP2SR4", ADDR_ASSIGN_RGID(0xE6060068, CONFIG_RCAR_RGID), 32, 4, GROUP(
		IP2SR4_31_28
		IP2SR4_27_24
		IP2SR4_23_20
		IP2SR4_19_16
	...
	{ PINMUX_CFG_REG("IP3SR4", ADDR_ASSIGN_RGID(0xE606006C, CONFIG_RCAR_RGID), 32, 4, GROUP(
	...
	{ PINMUX_CFG_REG("IP0SR5", ADDR_ASSIGN_RGID(0xE6060860, CONFIG_RCAR_RGID), 32, 4, GROUP(
		IP0SR5_31_28
		IP0SR5_27_24
		IP0SR5_23_20
		IP0SR5_19_16
	...
	{ PINMUX_CFG_REG("IP1SR5", ADDR_ASSIGN_RGID(0xE6060864, CONFIG_RCAR_RGID), 32, 4, GROUP(
		IP1SR5_31_28
		IP1SR5_27_24
		IP1SR5_23_20
		IP1SR5_19_16
	...
	{ PINMUX_CFG_REG("IP2SR5", ADDR_ASSIGN_RGID(0xE6060868, CONFIG_RCAR_RGID), 32, 4, GROUP(
...
static const struct pinmux_bias_reg pinmux_bias_regs[] = {
	{ PINMUX_BIAS_REG("PUEN0", ADDR_ASSIGN_RGID(0xE60500C0, CONFIG_RCAR_RGID), "PUD0", 0xE60500E0) {
	...
	{ PINMUX_BIAS_REG("PUEN1", ADDR_ASSIGN_RGID(0xE60508C0, CONFIG_RCAR_RGID), "PUD1", 0xE60508E0) {
	...
	{ PINMUX_BIAS_REG("PUEN2", ADDR_ASSIGN_RGID(0xE60580C0, CONFIG_RCAR_RGID), "PUD2", 0xE60580E0) {
	...
	{ PINMUX_BIAS_REG("PUEN3", ADDR_ASSIGN_RGID(0xE60588C0, CONFIG_RCAR_RGID), "PUD3", 0xE60588E0) {
	...
	{ PINMUX_BIAS_REG("PUEN4", ADDR_ASSIGN_RGID(0xE60600C0, CONFIG_RCAR_RGID), "PUD4", 0xE60600E0) {
	...
	{ PINMUX_BIAS_REG("PUEN5", ADDR_ASSIGN_RGID(0xE60608C0, CONFIG_RCAR_RGID), "PUD5", 0xE60608E0) {
	...
	{ PINMUX_BIAS_REG("PUEN6", ADDR_ASSIGN_RGID(0xE60610C0, CONFIG_RCAR_RGID), "PUD6", 0xE60610E0) {
	...
	{ PINMUX_BIAS_REG("PUEN7", ADDR_ASSIGN_RGID(0xE60618C0, CONFIG_RCAR_RGID), "PUD7", 0xE60618E0) {
