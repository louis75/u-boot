...
static const struct cpg_core_clk r8a779h0_core_clks[] = {
	...
	/* Core Clock Outputs */
	DEF_GEN4_Z("z0", R8A779H0_CLK_ZC0, CLK_TYPE_GEN4_Z, CLK_PLL2_DIV2, 4, 0),
	DEF_GEN4_Z("z1", R8A779H0_CLK_ZC1, CLK_TYPE_GEN4_Z, CLK_PLL2_DIV2, 4, 0),
	DEF_GEN4_Z("z2", R8A779H0_CLK_ZC2, CLK_TYPE_GEN4_Z, CLK_PLL2_DIV2, 4, 0),
	DEF_GEN4_Z("z3", R8A779H0_CLK_ZC3, CLK_TYPE_GEN4_Z, CLK_PLL2_DIV2, 4, 0),
...
static const struct mssr_mod_clk r8a779h0_mod_clks[] = {
	...
	DEF_MOD("imr0",         525,    R8A779H0_CLK_VCBUSD2),
	DEF_MOD("imr1",         526,    R8A779H0_CLK_VCBUSD2),
	DEF_MOD("ims0",         529,    R8A779H0_CLK_VCBUSD2),
	DEF_MOD("ims1",         530,    R8A779H0_CLK_VCBUSD2),
