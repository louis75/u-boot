...
static const struct cpg_core_clk r8a779h0_core_clks[] = {
	...
	/* Core Clock Outputs */
	DEF_GEN4_Z("z0", R8A779H0_CLK_ZC0, CLK_TYPE_GEN4_Z, CLK_PLL2, 4, 0),
	DEF_GEN4_Z("z1", R8A779H0_CLK_ZC1, CLK_TYPE_GEN4_Z, CLK_PLL2, 4, 8),
	DEF_GEN4_Z("z2", R8A779H0_CLK_ZC2, CLK_TYPE_GEN4_Z, CLK_PLL2, 4, 32),
	DEF_GEN4_Z("z3", R8A779H0_CLK_ZC3, CLK_TYPE_GEN4_Z, CLK_PLL2, 4, 40),
